  ...
  describe "when logged in as admin" do
    ...
    describe "handling GET /<%= permission_plural %>/" do
      ...
      it "should set @<%= permission_plural %>" do
        assigns[:<%= permission_plural %>].should == [@<%= permission_singular %>]
      end
    end
    ...
    describe "handling GET /<%= permission_plural %>/new" do
    ...
    describe "handling POST /<%= permission_plural %>/" do
    ...
    describe "handling GET /<%= group_plural %>/1/<%= permission_plural %>/1" do
    ...
    describe "handling GET /<%= group_plural %>/1/<%= permission_plural %>/1/edit" do
    ...
    describe "handling GET /<%= group_plural %>/1/<%= permission_plural %>/new" do
    ...
    describe "handling GET /<%= group_plural %>/1/<%= permission_plural %>/new.js" do
    ...
    describe "handling POST /<%= group_plural %>/1/<%= permission_plural %>/" do
    ...
    describe "handling PUT /<%= group_plural %>/1/<%= permission_plural %>/1" do
    ...
    describe "handling DELETE /<%= group_plural %>/1/<%= permission_plural %>/1" do
